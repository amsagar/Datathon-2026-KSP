...
export type { CustomBadgeProps } from './CustomBadge';
...
export type { CustomEmptyStateProps } from './CustomEmptyState';

export { default as CustomAvatar } from './CustomAvatar';
export type { CustomAvatarProps, CustomAvatarSize } from './CustomAvatar';

export { default as CustomTabs } from './CustomTabs';
export type { CustomTabsProps, CustomTabItem } from './CustomTabs';
